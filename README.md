...
```sh
git clone https://github.com/daotl/go-web-common
cd go-web-common
```
</details>
...
|      `run`     	| Run *go-web-common*                           	|       NA      	|
|  `docker-gen`  	| Create production docker image for *go-web-common* 	|     docker    	|
|  `docker-debug`  	| Create debug-friendly docker image for *go-web-common* 	|     docker    	|
